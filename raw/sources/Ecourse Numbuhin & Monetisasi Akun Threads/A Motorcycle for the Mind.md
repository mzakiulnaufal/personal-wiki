...
And I just like working with a great team to create something that I want to see exist. So hopefully we’ll create something that will come to fruition and people will say, “Wow, that’s great. I want that also,” or maybe not, but [it’s in the doing that you learn](https://nav.al/do).

## Vibe Coding Is the New Product Management

**Nivi:** So I pulled out a tweet from a couple days ago, [February 3rd](https://x.com/naval/status/2018633583423049951): “Vibe coding is the new product management. Training and tuning models is the new coding.”

**Naval:** There’s been a shift—a marked pronouncement in the last year and especially in the last few months—most pronounced by [Claude Code](https://code.claude.com/docs/en/overview), which is a specific model that has a coding engine in it, which is so good that I think now you have [vibe coders](https://en.wikipedia.org/wiki/Vibe_coding), which are people who didn’t really code much or hadn’t coded in a long time, who are using essentially English as a programming language—as an input into this code bot—which can do end-to-end coding.
...
**Naval:** So if anyone can code then what is coding? Coding still exists in a couple of areas. The most obvious place that coding exists is in training these models themselves. There are many different kinds of models. There are new ones coming out every day, there are different ones for different domains. We’re going to see different models for biology, for programming. We’re going to see pointed, focused models for sensors. We’re going to see models for [CAD](https://en.wikipedia.org/wiki/Computer-aided_design), for design.
...
But generally speaking, people only want the best of anything. So the bad news is there’s no point in being number two or number three—like in the famous [*Glengarry Glen Ross* scene](https://www.youtube.com/watch?v=wVQPY4LlbJ4) where Alec Baldwin says, “First place gets a Cadillac Eldorado, second place gets a set of steak knives, and third place you’re fired.”
...
However, the set of things you can be best at is infinite. You can always find some niche that is perfect for you, and you can be the best at that thing. This goes back to an [old tweet](https://x.com/naval/status/1002108897551773697) of mine where I said, “Become the best in the world at what you do. Keep redefining what you do until this is true.”
...
**Naval:** I think that’s correct in terms of the trend line. However, this is an emergent property. This is not a small improvement. This is a big leap. For example, when I was in school, I was programming mostly in [C](https://en.wikipedia.org/wiki/C_\(programming_language\)). And then [C++](https://en.wikipedia.org/wiki/C%2B%2B) came along and it wasn’t any easier.

It was like a little more abstract in some ways, and I never really bothered learning it. And then [Python](https://www.python.org/) came along and I was like, “Wow, this is almost like writing in English.”
...
**Nivi:** Maybe we already covered this enough, but over a year ago you [tweeted](https://x.com/naval/status/1875297712993964231) that “AI won’t replace programmers, but rather make it easier for programmers to replace everyone else.”
...
**Nivi:** Another tweet from a year ago, which is arguing, perhaps the complement of what we just talked about is from [February 9, 2025](https://x.com/naval/status/1888782266698187228): “No entrepreneur is worried about an AI taking their job.”
...
And even then people will challenge: is it alive? Because consciousness is one of those things that’s a [qualia](https://en.wikipedia.org/wiki/Qualia). It’s like a color. It’s like if you say red, I don’t know if you’re actually seeing red; you might be seeing what I see as green, and I might be seeing what you see as red. But we’ll never know because we can’t get into each other’s minds.
...
In fact, I would summarize this by saying the key thing that distinguishes entrepreneurs from everybody else right now in the economy is entrepreneurs have [extreme agency](https://nav.al/agency). That’s why it’s diametrically opposed to the idea of a job.
...
**Naval:** Humans are [universal explainers](https://nav.al/understand). Anything that is possible with the current laws of physics as we know them, a human can model in their own heads. Therefore just by enough digging—enough questioning—we can figure anything out.
...
What is the definition of intelligence? There’s the [G factor](https://en.wikipedia.org/wiki/G_factor_\(psychometrics\)), which predicts a lot of human outcomes, but the best evidence for the G factor is its predictive power. It’s that you measure this one thing and then you see people get much better life outcomes along the way in things that seem even somewhat unrelated to G.

So I would argue, and I think it’s one of my more popular [tweets](https://x.com/naval/status/1259593847580946432): the only true test of intelligence is if you get what you want out of life.
...
This is why I always say: [to invest in the future, you want to live in the future](https://x.com/naval/status/1846852622340239551). You want to actually be an avid consumer of technology, because it’s going to give you the best insight on how to use it, and it will give you an edge against the people who are slower adopters or laggards.
...
**Nivi:** Let’s talk about the [epistemology](https://plato.stanford.edu/entries/epistemology/) of AI, because I think the next big misconception is: AI is already starting to solve some unsolved basic math problems that a human probably could solve if they cared to, but they haven’t been solved yet—like [Erdős](https://en.wikipedia.org/wiki/Paul_Erd%C5%91s) Problem Number Whatever.
...
If you turn the crank on the human brain, you would end up with the same answer? And some people, like I think [Penrose](https://en.wikipedia.org/wiki/Roger_Penrose) is out there saying, “No, human brains are unique because of [quantum nanotubes](https://en.wikipedia.org/wiki/Orchestrated_objective_reduction).”
...
[Steve Jobs](https://en.wikipedia.org/wiki/Steve_Jobs) famously said that a computer is a bicycle for the mind. It lets you travel much faster than walking, certainly in terms of efficiency.
...
Because understanding what’s underneath the abstraction—what’s underneath that [command line](https://en.wikipedia.org/wiki/Command-line_interface) —is going to do two things.
...
Second is it’ll also help you understand whether you should be scared of it or not. Is this thing really going to metastasize into a [Skynet](https://en.wikipedia.org/wiki/Skynet_\(Terminator\)) and destroy the world?
